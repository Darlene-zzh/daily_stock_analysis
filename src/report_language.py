...
_REPORT_LABELS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "trigger_price_label": "触发价",
        "action_points_wait_notice": "_推荐策略为「暂不操作」，以下点位仅供参考，不建议据此入场。_",
    ...
    "en": {
        ...
        "action_points_wait_notice": "_Recommended strategy is \"wait_and_see\" — these levels are reference only; entry is not advised._",
