    ...
    >
          ...
          <Tooltip content={text.copyMarkdownSource}>
            <span className="inline-flex">
              <button
                ...
                className="home-surface-button flex size-10 items-center justify-center rounded-lg text-secondary-text hover:text-foreground disabled:opacity-50"
      ...
      {isLoading ? (
        <div className="flex flex-col items-center justify-center h-64">
          <div className="home-spinner size-10 animate-spin border-[3px]" />
          <p className="mt-4 text-secondary-text text-sm">{text.loadingReport}</p>
        </div>
      ) : error ? (
        <div className="flex flex-col items-center justify-center h-64">
          <div className="size-12 rounded-xl bg-danger/10 flex items-center justify-center mb-3">
