...
const REPORT_TEXT = {
  zh: {
    ...
    takeProfit: '止盈目标',
    noValue: '—',
    strategyPointsWaitNotice: '当前推荐策略为「暂不操作」，以下点位仅供参考，不建议据此入场。',
    newsFeed: '资讯动态',
    relatedNews: '相关资讯',
    refresh: '刷新',
    retry: '重试',
  ...
  en: {
    ...
    noValue: '—',
    strategyPointsWaitNotice: 'Recommended strategy is "wait_and_see" — these levels are reference only; entry is not advised.',
    newsFeed: 'NEWS FEED',
