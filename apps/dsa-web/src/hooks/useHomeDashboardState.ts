...
export function useHomeDashboardState() {
  const dashboardState = useStockPoolStore(
    useShallow((state) => ({
      ...
      notify: state.notify,
      portfolioAccountId: state.portfolioAccountId,
      enableInvestmentCommittee: state.enableInvestmentCommittee,
      committeeDebateRounds: state.committeeDebateRounds,
      setQuery: state.setQuery,
      setNotify: state.setNotify,
      setPortfolioAccountId: state.setPortfolioAccountId,
      setEnableInvestmentCommittee: state.setEnableInvestmentCommittee,
      setCommitteeDebateRounds: state.setCommitteeDebateRounds,
